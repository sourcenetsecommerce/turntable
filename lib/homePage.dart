  ...
  Widget build(BuildContext context) {
    ...
    (
      ...
      (
        ...
        child: postsList.length == 0 ? new Text("No news posts available") : new ListView.builder
        (
...
// there was a column here in case if something went wrongs
        child: new Wrap
        (
...
// download image url from firebase database 
